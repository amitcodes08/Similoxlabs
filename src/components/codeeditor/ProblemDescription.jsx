...
export default function ProblemDescription({
  ...
  return (
    <div className="flex flex-col h-full bg-white text-slate-800 border-r border-slate-200 select-text overflow-hidden">
      {/* Top Tab Bar */}
            ...
            <div className="space-y-4">
              ...
              {problem.examples.map((ex, idx) => (
                ...
                >
                  ...
                  <div className="space-y-1 font-mono text-slate-800 pl-3 border-l-2 border-slate-200">
                    <div>
                    ...
                    <div>
                      ...
                      <span className="bg-white px-1.5 py-0.5 rounded border border-slate-200 font-bold text-slate-900">
                        {ex.output}
                      </span>
                    </div>
                    {ex.explanation && (
